...
namespace NFePHP\NFSeFiorilli\Common\Soap;
...
use NFePHP\NFSeFiorilli\Common\Soap\SoapBase;
...
class SoapCurl extends SoapBase implements SoapInterface
{
    ...
    public function send(
        ...
        try {
            ...
            $this->soaperrno  = curl_errno($oCurl);
        ...
        if ($this->soaperror != '') {
            throw SoapException::soapFault($this->soaperror . " [$url]", $this->soaperrno);
        }
        if ($httpcode != 200) {
