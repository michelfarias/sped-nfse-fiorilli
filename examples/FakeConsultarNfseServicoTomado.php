...
try {
    ...
    //opcional
    $parameters->prestador = new \stdClass();
    $parameters->prestador->cnpj = '12345678901234'; 
    $parameters->prestador->cpf = '12345678901'; //deve declarar apenas se não for cnpj
    $parameters->prestador->im = '12345677'; //opcional
    ...
    $response = $tools->consultarNfseServicoTomado($parameters);
